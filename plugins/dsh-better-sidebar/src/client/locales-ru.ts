...
export const ru: Record<string, string> = {
  ...
  refreshWorktrees: 'Обновить рабочие деревья',
  worktreesEmpty: 'Нет доступных рабочих деревьев',
  detachedHead: 'Отсоединённый HEAD',
  copyWorktreePath: 'Копировать путь рабочего дерева',
  openTerminalInWorktree: 'Открыть терминал в рабочем дереве',
  currentWorktree: 'Текущее',
  lockedWorktree: 'Заблокировано',
  worktreeNoChanges: 'Нет изменений',
  worktreeChangeCount: '{count} изменений',
  repositoryUninitialized: 'Не инициализирован',
  repositoryMissing: 'Отсутствует',

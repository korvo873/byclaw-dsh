...
export const id: Record<string, string> = {
  ...
  worktree: 'Worktree',
  worktrees: 'Worktree',
  refreshWorktrees: 'Segarkan worktree',
  worktreesEmpty: 'Tidak ada worktree yang tersedia',
  detachedHead: 'HEAD terlepas',
  copyWorktreePath: 'Salin jalur worktree',
  openTerminalInWorktree: 'Buka terminal di worktree',
  currentWorktree: 'Saat ini',
  lockedWorktree: 'Terkunci',
  worktreeNoChanges: 'Tidak ada perubahan',
  worktreeChangeCount: '{count} perubahan',
  repositoryUninitialized: 'Belum diinisialisasi',
  repositoryMissing: 'Tidak ada',
  ...
  gitStatusCopied: 'Disalin',
  gitStatusUntracked: 'Tidak dilacak',

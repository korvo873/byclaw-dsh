...
export const fr: Record<string, string> = {
  ...
  refreshWorktrees: 'Actualiser les arborescences',
  worktreesEmpty: 'Aucune arborescence disponible',
  detachedHead: 'HEAD détachée',
  copyWorktreePath: 'Copier le chemin de l’arborescence',
  openTerminalInWorktree: 'Ouvrir un terminal dans l’arborescence',
  currentWorktree: 'Actuelle',
  lockedWorktree: 'Verrouillée',
  worktreeNoChanges: 'Aucune modification',
  worktreeChangeCount: '{count} modifications',
  repositoryUninitialized: 'Non initialisé',
  repositoryMissing: 'Manquant',

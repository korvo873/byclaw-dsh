...
export const tr: Record<string, string> = {
  ...
  refreshWorktrees: 'Çalışma ağaçlarını yenile',
  worktreesEmpty: 'Kullanılabilir çalışma ağacı yok',
  detachedHead: 'Ayrılmış HEAD',
  copyWorktreePath: 'Çalışma ağacı yolunu kopyala',
  openTerminalInWorktree: 'Çalışma ağacında terminal aç',
  currentWorktree: 'Geçerli',
  lockedWorktree: 'Kilitli',
  worktreeNoChanges: 'Değişiklik yok',
  worktreeChangeCount: '{count} değişiklik',
  repositoryUninitialized: 'Başlatılmadı',
  repositoryMissing: 'Eksik',
  ...
  gitStatusCopied: 'Kopyalandı',
  gitStatusUntracked: 'İzlenmiyor',
  gitStatusConflicted: 'Çakışma',
  cancel: 'İptal',

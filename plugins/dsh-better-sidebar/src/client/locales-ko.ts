...
export const ko: Record<string, string> = {
  ...
  worktree: '워크트리',
  worktrees: '워크트리',
  refreshWorktrees: '워크트리 새로 고침',
  worktreesEmpty: '사용 가능한 워크트리가 없습니다',
  detachedHead: '분리된 HEAD',
  copyWorktreePath: '워크트리 경로 복사',
  openTerminalInWorktree: '워크트리에서 터미널 열기',
  currentWorktree: '현재',
  lockedWorktree: '잠김',
  worktreeNoChanges: '변경 사항 없음',
  worktreeChangeCount: '변경 {count}개',
  repositoryUninitialized: '초기화되지 않음',
  repositoryMissing: '누락됨',
  ...
  gitStatusRenamed: '이름 변경됨',
  gitStatusCopied: '복사됨',
  gitStatusUntracked: '추적 안 됨',

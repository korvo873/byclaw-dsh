...
export const zhHK: Record<string, string> = {
  ...
  worktree: '工作樹',
  worktrees: '工作樹',
  refreshWorktrees: '重新整理工作樹',
  worktreesEmpty: '沒有可用的工作樹',
  detachedHead: '分離 HEAD',
  copyWorktreePath: '複製工作樹路徑',
  openTerminalInWorktree: '在工作樹中開啟終端機',
  currentWorktree: '目前',
  lockedWorktree: '已鎖定',
  worktreeNoChanges: '沒有變更',
  worktreeChangeCount: '{count} 個變更',
  ...
  gitStatusCopied: '已複製',
  gitStatusUntracked: '未追蹤',
  gitStatusConflicted: '衝突',
  cancel: '取消',
  diffEmpty: '沒有文字差異',

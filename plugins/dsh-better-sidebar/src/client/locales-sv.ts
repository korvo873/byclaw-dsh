export const sv: Record<string, string> = {
  ...
  branch: 'Gren',
  worktree: 'Arbetsträd',
  worktrees: 'Arbetsträd',
  refreshWorktrees: 'Uppdatera arbetsträd',
  worktreesEmpty: 'Inga arbetsträd tillgängliga',
  detachedHead: 'Frikopplad HEAD',
  copyWorktreePath: 'Kopiera arbetsträdets sökväg',
  openTerminalInWorktree: 'Öppna terminal i arbetsträdet',
  currentWorktree: 'Aktuellt',
  lockedWorktree: 'Låst',
  worktreeNoChanges: 'Inga ändringar',
  worktreeChangeCount: '{count} ändringar',
  repositoryUninitialized: 'Inte initierad',
  repositoryMissing: 'Saknas',
  ...
  gitStatusRenamed: 'Omdöpt',
  gitStatusCopied: 'Kopierad',

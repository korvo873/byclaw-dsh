...
export const hi: Record<string, string> = {
  ...
  worktree: 'वर्कट्री',
  worktrees: 'वर्कट्री',
  refreshWorktrees: 'वर्कट्री रीफ़्रेश करें',
  worktreesEmpty: 'कोई वर्कट्री उपलब्ध नहीं',
  detachedHead: 'अलग HEAD',
  copyWorktreePath: 'वर्कट्री पथ कॉपी करें',
  openTerminalInWorktree: 'वर्कट्री में टर्मिनल खोलें',
  currentWorktree: 'वर्तमान',
  lockedWorktree: 'लॉक',
  worktreeNoChanges: 'कोई बदलाव नहीं',
  worktreeChangeCount: '{count} बदलाव',
  repositoryUninitialized: 'आरंभ नहीं किया गया',
  repositoryMissing: 'अनुपलब्ध',
  ...
  gitStatusModified: 'संशोधित',
  gitStatusDeleted: 'हटाया गया',
  gitStatusRenamed: 'नाम बदला गया',
  gitStatusCopied: 'कॉपी किया गया',
  gitStatusUntracked: 'अनट्रैक किया गया',
  gitStatusConflicted: 'विरोध',
  cancel: 'रद्द करें',

...
export const vi: Record<string, string> = {
  ...
  worktree: 'Worktree',
  worktrees: 'Worktree',
  refreshWorktrees: 'Làm mới worktree',
  worktreesEmpty: 'Không có worktree khả dụng',
  detachedHead: 'HEAD tách rời',
  copyWorktreePath: 'Sao chép đường dẫn worktree',
  openTerminalInWorktree: 'Mở terminal trong worktree',
  currentWorktree: 'Hiện tại',
  lockedWorktree: 'Đã khóa',
  worktreeNoChanges: 'Không có thay đổi',
  worktreeChangeCount: '{count} thay đổi',
  repositoryUninitialized: 'Chưa khởi tạo',
  repositoryMissing: 'Bị thiếu',
  checkoutError: 'Chuyển branch thất bại',
  history: 'Lịch sử',
  changes: 'Thay đổi',
  staged: 'Đã stage',
  unstaged: 'Chưa stage',
  gitStatusAdded: 'Đã thêm',
  gitStatusModified: 'Đã sửa đổi',
  gitStatusDeleted: 'Đã xóa',
  gitStatusRenamed: 'Đã đổi tên',
  gitStatusCopied: 'Đã sao chép',
  gitStatusUntracked: 'Chưa theo dõi',
  gitStatusConflicted: 'Xung đột',
  cancel: 'Hủy',

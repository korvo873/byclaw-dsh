...
export const th: Record<string, string> = {
  ...
  worktree: 'เวิร์กทรี',
  worktrees: 'เวิร์กทรี',
  refreshWorktrees: 'รีเฟรชเวิร์กทรี',
  worktreesEmpty: 'ไม่มีเวิร์กทรีที่ใช้งานได้',
  detachedHead: 'HEAD แยก',
  copyWorktreePath: 'คัดลอกพาธเวิร์กทรี',
  openTerminalInWorktree: 'เปิดเทอร์มินัลในเวิร์กทรี',
  currentWorktree: 'ปัจจุบัน',
  lockedWorktree: 'ล็อกแล้ว',
  worktreeNoChanges: 'ไม่มีการเปลี่ยนแปลง',
  worktreeChangeCount: '{count} การเปลี่ยนแปลง',
  repositoryUninitialized: 'ยังไม่ได้เริ่มต้น',
  repositoryMissing: 'ไม่พบ',
  checkoutError: 'สลับ branch ล้มเหลว',
  history: 'ประวัติ',
  changes: 'การเปลี่ยนแปลง',
  staged: 'Staged',
  unstaged: 'Unstaged',
  gitStatusAdded: 'เพิ่มแล้ว',
  gitStatusModified: 'แก้ไขแล้ว',
  gitStatusDeleted: 'ลบแล้ว',
  gitStatusRenamed: 'เปลี่ยนชื่อแล้ว',
  gitStatusCopied: 'คัดลอกแล้ว',
  gitStatusUntracked: 'ยังไม่ติดตาม',
  gitStatusConflicted: 'ขัดแย้ง',
  cancel: 'ยกเลิก',

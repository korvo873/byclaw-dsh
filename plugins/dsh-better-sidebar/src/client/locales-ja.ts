...
export const ja: Record<string, string> = {
  ...
  worktree: 'ワークツリー',
  worktrees: 'ワークツリー',
  refreshWorktrees: 'ワークツリーを更新',
  worktreesEmpty: '利用可能なワークツリーはありません',
  detachedHead: 'デタッチされた HEAD',
  copyWorktreePath: 'ワークツリーのパスをコピー',
  openTerminalInWorktree: 'ワークツリーでターミナルを開く',
  currentWorktree: '現在',
  lockedWorktree: 'ロック済み',
  worktreeNoChanges: '変更なし',
  worktreeChangeCount: '{count} 件の変更',
  repositoryUninitialized: '未初期化',
  repositoryMissing: '見つかりません',
  ...
  gitStatusRenamed: '名前変更済み',
  gitStatusCopied: 'コピー済み',

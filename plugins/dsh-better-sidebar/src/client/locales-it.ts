...
export const it: Record<string, string> = {
  ...
  refreshWorktrees: 'Aggiorna alberi di lavoro',
  worktreesEmpty: 'Nessun albero di lavoro disponibile',
  detachedHead: 'HEAD scollegato',
  copyWorktreePath: 'Copia percorso dell’albero di lavoro',
  openTerminalInWorktree: 'Apri terminale nell’albero di lavoro',
  currentWorktree: 'Corrente',
  lockedWorktree: 'Bloccato',
  worktreeNoChanges: 'Nessuna modifica',
  worktreeChangeCount: '{count} modifiche',
  repositoryUninitialized: 'Non inizializzato',
  repositoryMissing: 'Mancante',

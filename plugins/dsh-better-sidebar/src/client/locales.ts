...
export const zh = {
  ...
  worktreesEmpty: '没有可用的工作树',
  detachedHead: '分离 HEAD',
  copyWorktreePath: '复制工作树路径',
  openTerminalInWorktree: '在工作树中打开终端',
  currentWorktree: '当前',
  lockedWorktree: '已锁定',
  worktreeNoChanges: '没有变更',
  worktreeChangeCount: '{count} 个变更',
  repositoryUninitialized: '未初始化',
  repositoryMissing: '缺失',
  checkoutError: '切换分支失败',
  history: '历史',
  historySearchPlaceholder: '搜索提交信息或 hash',
  historyBranchFilter: '分支筛选',
  historyCurrent: '当前',
  historyAllBranches: '全部分支',
  historyLocalBranches: '本地分支',
  historyRemoteBranches: '远程分支',
  historyAuthorFilter: '作者',
  historySince: '起始',
  historyUntil: '结束',
  historyPathFilter: '路径',
  historyEmpty: '没有匹配的提交',
  changes: '变更',
  staged: '已暂存',
  unstaged: '未暂存',
  gitStatusAdded: '新增',
  ...
  subagentExpandBranch: '展开 {name}',
  subagentCollapseBranch: '折叠 {name}',
  subagentEmpty: '暂无子代理',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  worktreesEmpty: 'No worktrees available',
  detachedHead: 'Detached HEAD',
  copyWorktreePath: 'Copy worktree path',
  openTerminalInWorktree: 'Open terminal in worktree',
  currentWorktree: 'Current',
  lockedWorktree: 'Locked',
  worktreeNoChanges: 'No changes',
  worktreeChangeCount: '{count} changes',
  repositoryUninitialized: 'Uninitialized',
  repositoryMissing: 'Missing',
  checkoutError: 'Branch switch failed',
  history: 'History',
  historySearchPlaceholder: 'Search message or hash',
  historyBranchFilter: 'Branch filter',
  historyCurrent: 'Current',
  historyAllBranches: 'All branches',
  historyLocalBranches: 'Local branches',
  historyRemoteBranches: 'Remote branches',
  historyAuthorFilter: 'Author',
  historySince: 'Since',
  historyUntil: 'Until',
  historyPathFilter: 'Path',
  historyEmpty: 'No matching commits',
  changes: 'Changes',
  staged: 'Staged',
  unstaged: 'Unstaged',
  ...
  subagentExpandBranch: 'Expand {name}',
  subagentCollapseBranch: 'Collapse {name}',
...
/** Third-language dictionaries inherit new strings from English until translated. */
export const ja: Record<keyof typeof zh, string> = { ...en, ...jaDict }
export const de: Record<keyof typeof zh, string> = { ...en, ...deDict }
export const fr: Record<keyof typeof zh, string> = { ...en, ...frDict }
export const pt: Record<keyof typeof zh, string> = { ...en, ...ptDict }
export const ko: Record<keyof typeof zh, string> = { ...en, ...koDict }
export const ar: Record<keyof typeof zh, string> = { ...en, ...arDict }
export const hi: Record<keyof typeof zh, string> = { ...en, ...hiDict }
export const id: Record<keyof typeof zh, string> = { ...en, ...idDict }
export const tr: Record<keyof typeof zh, string> = { ...en, ...trDict }
export const vi: Record<keyof typeof zh, string> = { ...en, ...viDict }
export const th: Record<keyof typeof zh, string> = { ...en, ...thDict }
export const ru: Record<keyof typeof zh, string> = { ...en, ...ruDict }
export const it: Record<keyof typeof zh, string> = { ...en, ...itDict }
export const nl: Record<keyof typeof zh, string> = { ...en, ...nlDict }
export const sv: Record<keyof typeof zh, string> = { ...en, ...svDict }
export const pl: Record<keyof typeof zh, string> = { ...en, ...plDict }
export const zhHK: Record<keyof typeof zh, string> = { ...en, ...zhHKDict }
export const zhTW: Record<keyof typeof zh, string> = { ...en, ...zhTWDict }
export const zhMO: Record<keyof typeof zh, string> = { ...en, ...zhMODict }

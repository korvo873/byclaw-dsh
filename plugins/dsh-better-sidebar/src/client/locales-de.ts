...
export const de: Record<string, string> = {
  ...
  worktree: 'Worktree',
  worktrees: 'Worktrees',
  refreshWorktrees: 'Worktrees aktualisieren',
  worktreesEmpty: 'Keine Worktrees verfügbar',
  detachedHead: 'Losgelöster HEAD',
  copyWorktreePath: 'Worktree-Pfad kopieren',
  openTerminalInWorktree: 'Terminal im Worktree öffnen',
  currentWorktree: 'Aktuell',
  lockedWorktree: 'Gesperrt',
  worktreeNoChanges: 'Keine Änderungen',
  worktreeChangeCount: '{count} Änderungen',
  repositoryUninitialized: 'Nicht initialisiert',
  repositoryMissing: 'Fehlt',

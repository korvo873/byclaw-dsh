...
export const nl: Record<string, string> = {
  ...
  worktree: 'Worktree',
  worktrees: 'Worktrees',
  refreshWorktrees: 'Worktrees vernieuwen',
  worktreesEmpty: 'Geen worktrees beschikbaar',
  detachedHead: 'Losgekoppelde HEAD',
  copyWorktreePath: 'Worktree-pad kopiëren',
  openTerminalInWorktree: 'Terminal openen in worktree',
  currentWorktree: 'Huidig',
  lockedWorktree: 'Vergrendeld',
  worktreeNoChanges: 'Geen wijzigingen',
  worktreeChangeCount: '{count} wijzigingen',
  repositoryUninitialized: 'Niet geïnitialiseerd',
  repositoryMissing: 'Ontbreekt',
  ...
  gitStatusCopied: 'Gekopieerd',
  gitStatusUntracked: 'Niet gevolgd',

...
export const ar: Record<string, string> = {
  ...
  refreshWorktrees: 'تحديث أشجار العمل',
  worktreesEmpty: 'لا توجد أشجار عمل متاحة',
  detachedHead: 'HEAD منفصل',
  copyWorktreePath: 'نسخ مسار شجرة العمل',
  openTerminalInWorktree: 'فتح الطرفية في شجرة العمل',
  currentWorktree: 'الحالية',
  lockedWorktree: 'مقفلة',
  worktreeNoChanges: 'لا تغييرات',
  worktreeChangeCount: '{count} تغييرات',
  repositoryUninitialized: 'غير مهيأ',
  repositoryMissing: 'مفقود',
  ...
  unstaged: 'غير مُدرج',
  gitStatusAdded: 'مضاف',
  gitStatusModified: 'معدّل',
  gitStatusDeleted: 'محذوف',
  gitStatusRenamed: 'مُعاد التسمية',
  gitStatusCopied: 'منسوخ',
  gitStatusUntracked: 'غير متعقّب',

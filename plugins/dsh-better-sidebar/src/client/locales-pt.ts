export const pt: Record<string, string> = {
  ...
  worktree: 'Worktree',
  worktrees: 'Worktrees',
  refreshWorktrees: 'Atualizar worktrees',
  worktreesEmpty: 'Nenhuma worktree disponível',
  detachedHead: 'HEAD destacado',
  copyWorktreePath: 'Copiar caminho da worktree',
  openTerminalInWorktree: 'Abrir terminal na worktree',
  currentWorktree: 'Atual',
  lockedWorktree: 'Bloqueada',
  worktreeNoChanges: 'Sem alterações',
  worktreeChangeCount: '{count} alterações',
  repositoryUninitialized: 'Não inicializado',
  repositoryMissing: 'Ausente',

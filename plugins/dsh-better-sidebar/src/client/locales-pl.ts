...
export const pl: Record<string, string> = {
  ...
  refreshWorktrees: 'Odśwież drzewa robocze',
  worktreesEmpty: 'Brak dostępnych drzew roboczych',
  detachedHead: 'Odłączony HEAD',
  copyWorktreePath: 'Kopiuj ścieżkę drzewa roboczego',
  openTerminalInWorktree: 'Otwórz terminal w drzewie roboczym',
  currentWorktree: 'Bieżące',
  lockedWorktree: 'Zablokowane',
  worktreeNoChanges: 'Brak zmian',
  worktreeChangeCount: '{count} zmian',
  repositoryUninitialized: 'Niezainicjowane',
  repositoryMissing: 'Brak',
  ...
  gitStatusCopied: 'Skopiowano',
  gitStatusUntracked: 'Nieśledzony',
